// Export of 'Fallujah_Spawns.fallujah' by [F.E.L] Cabo lock on v0.9
...
if (_layerRoot) then {
	_item1 = _item0 createUnit ["UK3CB_MEI_O_SL",[4989.36,6557.45,0],[],0,"CAN_COLLIDE"];
	_item0 selectLeader _item1;
	_this = _item1;
	_objects pushback _this;
	_objectIDs pushback 1;
	_this setPosWorld [4989.36,6557.5,6.99145];
...
if (_layerRoot) then {
	_item2 = _item0 createUnit ["UK3CB_MEI_O_TL",[5026.52,6709.47,0],[],0,"CAN_COLLIDE"];
	_this = _item2;
	_objects pushback _this;
	_objectIDs pushback 2;
	_this setPosWorld [5026.52,6709.52,6.99145];
...
if (_layerRoot) then {
	_item3 = _item0 createUnit ["UK3CB_MEI_O_MD",[4903.57,6638.32,0],[],0,"CAN_COLLIDE"];
	_this = _item3;
	_objects pushback _this;
	_objectIDs pushback 3;
	_this setPosWorld [4903.57,6638.37,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item4 = _item0 createUnit ["UK3CB_MEI_O_AT",[4986.92,6586.21,0],[],0,"CAN_COLLIDE"];
	_this = _item4;
	_objects pushback _this;
	_objectIDs pushback 4;
	_this setPosWorld [4986.92,6586.26,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item5 = _item0 createUnit ["UK3CB_MEI_O_AT_ASST",[4915.69,6486.67,0],[],0,"CAN_COLLIDE"];
	_this = _item5;
	_objects pushback _this;
	_objectIDs pushback 5;
	_this setPosWorld [4915.69,6486.72,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item6 = _item0 createUnit ["UK3CB_MEI_O_MK",[4927.35,6438.67,0],[],0,"CAN_COLLIDE"];
	_this = _item6;
	_objects pushback _this;
	_objectIDs pushback 6;
	_this setPosWorld [4927.35,6438.72,6.99145];
...
if (_layerRoot) then {
	_item7 = _item0 createUnit ["UK3CB_MEI_O_AR_01",[5131.3,6558.51,-4.76837e-07],[],0,"CAN_COLLIDE"];
	_this = _item7;
	_objects pushback _this;
	_objectIDs pushback 7;
	_this setPosWorld [5131.3,6558.56,7.00144];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item8 = _item0 createUnit ["UK3CB_MEI_O_RIF_3",[4892.95,6571.38,3.1],[],0,"CAN_COLLIDE"];
	_this = _item8;
	_objects pushback _this;
	_objectIDs pushback 8;
	_this setPosWorld [4892.95,6571.43,10.0914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item20 = _item0 createUnit ["UK3CB_MEI_O_TL",[4871.26,6531.82,0],[],0,"CAN_COLLIDE"];
	_this = _item20;
	_objects pushback _this;
	_objectIDs pushback 20;
	_this setPosWorld [4871.26,6531.87,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item21 = _item0 createUnit ["UK3CB_MEI_O_MD",[4889.26,6728.75,3.1],[],0,"CAN_COLLIDE"];
	_this = _item21;
	_objects pushback _this;
	_objectIDs pushback 21;
	_this setPosWorld [4889.26,6728.8,10.0914];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item22 = _item0 createUnit ["UK3CB_MEI_O_AT",[5093.6,6420.92,0],[],0,"CAN_COLLIDE"];
	_this = _item22;
	_objects pushback _this;
	_objectIDs pushback 22;
	_this setPosWorld [5093.6,6420.97,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item23 = _item0 createUnit ["UK3CB_MEI_O_AT_ASST",[4994.46,6501.61,0],[],0,"CAN_COLLIDE"];
	_this = _item23;
	_objects pushback _this;
	_objectIDs pushback 23;
	_this setPosWorld [4994.46,6501.66,6.99145];
...
if (_layerRoot) then {
	_item24 = _item0 createUnit ["UK3CB_MEI_O_MK",[5004.91,6446.79,0],[],0,"CAN_COLLIDE"];
	_this = _item24;
	_objects pushback _this;
	_objectIDs pushback 24;
	_this setPosWorld [5004.91,6446.83,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item25 = _item0 createUnit ["UK3CB_MEI_O_AR_01",[4855.65,6558.49,0],[],0,"CAN_COLLIDE"];
	_this = _item25;
	_objects pushback _this;
	_objectIDs pushback 25;
	_this setPosWorld [4855.65,6558.54,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item26 = _item0 createUnit ["UK3CB_MEI_O_RIF_3",[5073.55,6491.77,0],[],0,"CAN_COLLIDE"];
	_this = _item26;
	_objects pushback _this;
	_objectIDs pushback 26;
	_this setPosWorld [5073.55,6491.82,6.99145];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item18 = (group (missionNamespace getvariable ["BIS_functions_mainscope",objnull])) createUnit ["lambs_wp_TaskGarrison",[4977.24,6538.25,0],[],0,"CAN_COLLIDE"];
	_this = _item18;
	_logics pushback _this;
	_logicIDs pushback 18;
	_this setPosWorld [4977.24,6538.25,6.99001];
