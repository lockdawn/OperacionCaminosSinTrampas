// Export of 'OCST_Fallujah_vip_guard_01.fallujah' by [F.E.L] Cabo lock on v0.9
...
if (_layerRoot) then {
	_item1 = _item0 createUnit ["UK3CB_MEE_O_SL",[3873.69,6044.44,1.212],[],0,"CAN_COLLIDE"];
	_item0 selectLeader _item1;
	_this = _item1;
	_objects pushback _this;
	_objectIDs pushback 1;
	_this setPosWorld [3873.69,6044.49,8.20345];
	_this setVectorDirAndUp [[0.934633,-0.355613,0],[0,0,1]];
...
if (_layerRoot) then {
	_item2 = _item0 createUnit ["UK3CB_MEE_O_TL",[3871.12,6043.61,1.21201],[],0,"CAN_COLLIDE"];
	_this = _item2;
	_objects pushback _this;
	_objectIDs pushback 2;
	_this setPosWorld [3871.12,6043.66,8.20346];
...
if (_layerRoot) then {
	_item3 = _item0 createUnit ["UK3CB_MEE_O_MD",[3869.39,6038.08,1.21201],[],0,"CAN_COLLIDE"];
	_this = _item3;
	_objects pushback _this;
	_objectIDs pushback 3;
	_this setPosWorld [3869.39,6038.13,8.20346];
	_this setVectorDirAndUp [[1,0.000885443,0],[0,0,1]];
...
if (_layerRoot) then {
	_item4 = _item0 createUnit ["UK3CB_MEE_O_MK",[3874.79,6028.42,1.212],[],0,"CAN_COLLIDE"];
	_this = _item4;
	_objects pushback _this;
	_objectIDs pushback 4;
	_this setPosWorld [3874.79,6028.47,8.20345];
...
if (_layerRoot) then {
	_item5 = _item0 createUnit ["UK3CB_MEE_O_MG",[3874.09,6035.08,1.212],[],0,"CAN_COLLIDE"];
	_this = _item5;
	_objects pushback _this;
	_objectIDs pushback 5;
	_this setPosWorld [3874.09,6035.13,8.20345];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item6 = _item0 createUnit ["UK3CB_MEE_O_MG_ASST",[3872.79,6027.97,1.21201],[],0,"CAN_COLLIDE"];
	_this = _item6;
	_objects pushback _this;
	_objectIDs pushback 6;
	_this setPosWorld [3872.79,6028.02,8.20346];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item7 = _item0 createUnit ["UK3CB_MEE_O_ENG",[3871.54,6021.67,1.21201],[],0,"CAN_COLLIDE"];
	_this = _item7;
	_objects pushback _this;
	_objectIDs pushback 7;
	_this setPosWorld [3871.54,6021.72,8.20346];
	_this setVectorDirAndUp [[0,1,0],[0,0,1]];
...
if (_layerRoot) then {
	_item8 = _item0 createUnit ["UK3CB_MEE_O_RIF_1",[3875.39,6026.24,1.21201],[],0,"CAN_COLLIDE"];
	_this = _item8;
	_objects pushback _this;
	_objectIDs pushback 8;
	_this setPosWorld [3875.39,6026.29,8.20346];
